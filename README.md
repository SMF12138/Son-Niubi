...
| 30 日 | 53.7% | 67.2%（n=290） | 61.8%（n=880） | 50.9% |
| 60 日 | 51.3% | 60.7%（n=407） | 61.8%（n=861） | 50.1% |
| 90 日 | 59.1% | **73.2%**（n=553） | 59.0%（n=899） | 52.5% |
...
> ³ **MOEX 期**：2022-06 起有 MOEX 在岸成交的子集；MOEX 期高置信（OOS）命中率分别为 70.0% / 67.2% / 65.1%（n=335）/ 69.0%（n=219）。
...
| N=30 | **74.8%** | 65.0% | 65.0% | 56.1% |
| N=60 | **76.0%** | 72.7% | 65.2% | 53.6% |
| N=90 | **76.3%** | 72.3% | 58.6% | 49.8% |
...
- 方向预测超越随机是**微弱但真实**的：MOEX 期命中率 59–68%（超额基线 +6~10 点）；全样本 7/90 日超额约 +6 点，30/60 日仅 +1~3 点（边际水平）。样本外高置信档 61–73%，但覆盖率只有 9–18% 的窗口。
